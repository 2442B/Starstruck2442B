...
void runMainCompAuton(string side)
{
	...
	if(side == "left")
		turnClockwise(95); //90 deg, but kinda guess and check - turn right
	else if(side == "right")
		turnCounterClockwise(95); //turn left
	wait1Msec(500);
	...
	if(side == "left")
		turnClockwise(95); //turn to face cube
	else if(side == "right")
		turnCounterClockwise(95); //turn to face cube

	wait1Msec(750);
	setLiftPower(0);
	driveForDistance(125); //forward to snag cube
	setPincerPower(-127); //maybe works, hopefully holds pincer shut
	wait1Msec(2000);
	driveBackForDistance(-300, -127); //back to fence
	setLiftPower(127);
